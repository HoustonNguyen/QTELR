...
namespace QTELR_Interface
{
    static class SphereCoordinates
    {
        ...
        {
            //x_0 = x_0 + radius_0 * Math.Cos(angle1);
            //y_0 = x_0 + radius_0 * Math.Cos(angle1);
            //z_0 = z_0 + radius_0 * Math.Sin(angle1);
            //radius_0 = Math.Sqrt(Math.Pow(x_0, 2) + Math.Pow(y_0, 2) + Math.Pow(z_0, 2));
